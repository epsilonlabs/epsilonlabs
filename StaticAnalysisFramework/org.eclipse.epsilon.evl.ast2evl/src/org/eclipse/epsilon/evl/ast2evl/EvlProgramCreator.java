...
public class EvlProgramCreator extends EvlElementCreator{
	...
	public EOLElement create(AST ast, EOLElement container,
		...
		if (preAsts != null) {
			...
			{
				program.getPreBlocks().add( (NamedBlock) _context.getEvlElementCreatorFactory().createDomElement(preBlockAst, program, _context));
			}
		}
		...
		if (postAsts != null) {
			...
			{
				program.getPostBlocks().add( (NamedBlock) _context.getEvlElementCreatorFactory().createDomElement(postBlockAst, program, _context));
			}
		}
