...
public class EolSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EolPackage.SELF_INNERMOST_CONTENT_TYPE: {
				SelfInnermostContentType selfInnermostContentType = (SelfInnermostContentType)theEObject;
				T result = caseSelfInnermostContentType(selfInnermostContentType);
				if (result == null) result = casePseudoType(selfInnermostContentType);
				if (result == null) result = caseAnyType(selfInnermostContentType);
				if (result == null) result = caseType(selfInnermostContentType);
				if (result == null) result = caseEOLElement(selfInnermostContentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Self Innermost Content Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Self Innermost Content Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
