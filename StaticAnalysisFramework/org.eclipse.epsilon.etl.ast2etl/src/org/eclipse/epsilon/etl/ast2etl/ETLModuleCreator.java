...
public class ETLModuleCreator extends EtlElementCreator{
	...
	public EOLElement create(AST ast, EOLElement container,
		...
		if (preAsts != null) {
			...
			{
				program.getPreBlocks().add((NamedBlock) _context.getEtlElementCreatorFactory().createDomElement(preBlockAst, program, _context, NamedBlockCreator.class));
			}
		}
		...
		if (postAsts != null) {
			...
			{
				program.getPostBlocks().add((NamedBlock) _context.getEtlElementCreatorFactory().createDomElement(postBlockAst, program, _context, NamedBlockCreator.class));
			}
		}
