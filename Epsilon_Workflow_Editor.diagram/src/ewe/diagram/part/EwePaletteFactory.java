...
public class EwePaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		...
		paletteContainer.add(createLoadModelTask11CreationTool());
	 ...
	 * @generated
	 */
	private ToolEntry createLoadModelTask11CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.LoadModelTask11CreationTool_title,
				Messages.LoadModelTask11CreationTool_desc,
				Collections.singletonList(EweElementTypes.LoadModelTask_3011));
		entry.setId("createLoadModelTask11CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(EweElementTypes
