 ...
 * @generated
 */
public class EweElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public EweElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.EweElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "ewe".equals(fileExtension); //$NON-NLS-1$
	}
