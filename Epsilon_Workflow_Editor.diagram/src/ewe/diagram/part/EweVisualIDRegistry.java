...
public class EweVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case TargetTargetTargetTasksCompartmentEditPart.VISUAL_ID:
			...
			if (EwePackage.eINSTANCE.getDisposeModelsTask().isSuperTypeOf(
					domainElement.eClass())) {
				return DisposeModelsTaskEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case DisposeModelsTaskEditPart.VISUAL_ID:
			if (DisposeModelsTaskNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case TargetTargetTargetTasksCompartmentEditPart.VISUAL_ID:
			...
			if (DisposeModelsTaskEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
