 ...
 * @generated
 */
public class EweViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ProjectEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& EweVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EweVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EweVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!EweElementTypes.isKnownElementType(elementType)
				...
				if (!ProjectEditPart.MODEL_ID.equals(EweVisualIDRegistry
		...
		return TargetEditPart.VISUAL_ID == visualID
				|| EolTaskEditPart.VISUAL_ID == visualID
				|| EmlTaskEditPart.VISUAL_ID == visualID
				|| EglTaskEditPart.VISUAL_ID == visualID
				|| EtlTaskEditPart.VISUAL_ID == visualID
				|| EvlTaskEditPart.VISUAL_ID == visualID
				|| LoadEMFModelTaskEditPart.VISUAL_ID == visualID
				|| LoadXMLModelTaskEditPart.VISUAL_ID == visualID
				|| FlockTaskEditPart.VISUAL_ID == visualID
				|| EUnitTaskEditPart.VISUAL_ID == visualID
				|| EclTaskEditPart.VISUAL_ID == visualID
				|| LoadModelTaskEditPart.VISUAL_ID == visualID
				|| StoreModelTaskEditPart.VISUAL_ID == visualID
				|| RollbackTransactionTaskEditPart.VISUAL_ID == visualID
				|| DisposeModelTaskEditPart.VISUAL_ID == visualID
				|| StartTransactionTaskEditPart.VISUAL_ID == visualID
				|| CommitTransactionTaskEditPart.VISUAL_ID == visualID
				|| PropertyEditPart.VISUAL_ID == visualID
				|| NestedElementEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EweVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EweVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = EweVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = EweVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TargetEditPart.VISUAL_ID:
			return createTarget_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case EolTaskEditPart.VISUAL_ID:
			return createEolTask_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case EmlTaskEditPart.VISUAL_ID:
			return createEmlTask_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EglTaskEditPart.VISUAL_ID:
			return createEglTask_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case EtlTaskEditPart.VISUAL_ID:
			return createEtlTask_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case EvlTaskEditPart.VISUAL_ID:
			return createEvlTask_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case LoadEMFModelTaskEditPart.VISUAL_ID:
			return createLoadEMFModelTask_3006(domainElement, containerView,
					index, persisted, preferencesHint);
		case LoadXMLModelTaskEditPart.VISUAL_ID:
			return createLoadXMLModelTask_3007(domainElement, containerView,
					index, persisted, preferencesHint);
		case FlockTaskEditPart.VISUAL_ID:
			return createFlockTask_3008(domainElement, containerView, index,
					persisted, preferencesHint);
		case EUnitTaskEditPart.VISUAL_ID:
			return createEUnitTask_3009(domainElement, containerView, index,
					persisted, preferencesHint);
		case EclTaskEditPart.VISUAL_ID:
			return createEclTask_3010(domainElement, containerView, index,
					persisted, preferencesHint);
		case LoadModelTaskEditPart.VISUAL_ID:
			return createLoadModelTask_3011(domainElement, containerView,
					index, persisted, preferencesHint);
		case StoreModelTaskEditPart.VISUAL_ID:
			return createStoreModelTask_3012(domainElement, containerView,
					index, persisted, preferencesHint);
		case RollbackTransactionTaskEditPart.VISUAL_ID:
			return createRollbackTransactionTask_3013(domainElement,
					containerView, index, persisted, preferencesHint);
		case DisposeModelTaskEditPart.VISUAL_ID:
			return createDisposeModelTask_3014(domainElement, containerView,
					index, persisted, preferencesHint);
		case StartTransactionTaskEditPart.VISUAL_ID:
			return createStartTransactionTask_3015(domainElement,
					containerView, index, persisted, preferencesHint);
		case CommitTransactionTaskEditPart.VISUAL_ID:
			return createCommitTransactionTask_3016(domainElement,
					containerView, index, persisted, preferencesHint);
		case PropertyEditPart.VISUAL_ID:
			return createProperty_3017(domainElement, containerView, index,
					persisted, preferencesHint);
		case NestedElementEditPart.VISUAL_ID:
			return createNestedElement_3018(domainElement, containerView,
					index, persisted, preferencesHint);
		case TaskEditPart.VISUAL_ID:
			return createTask_3019(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EweVisualIDRegistry.getVisualID(elementTypeHint)) {
		case TaskFollowsEditPart.VISUAL_ID:
			return createTaskFollows_4001(containerView, index, persisted,
					preferencesHint);
		case TargetDependsEditPart.VISUAL_ID:
			return createTargetDepends_4002(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTarget_2001(EObject domainElement, View containerView,
		...
		node.setType(EweVisualIDRegistry.getType(TargetEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createEolTask_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EolTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEmlTask_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EmlTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEglTask_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EglTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEtlTask_3004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EtlTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEvlTask_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EvlTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createLoadEMFModelTask_3006(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createLoadXMLModelTask_3007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createFlockTask_3008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(FlockTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEUnitTask_3009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EUnitTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEclTask_3010(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(EclTaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createLoadModelTask_3011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createStoreModelTask_3012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createRollbackTransactionTask_3013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createDisposeModelTask_3014(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createStartTransactionTask_3015(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createCommitTransactionTask_3016(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createProperty_3017(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(PropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createNestedElement_3018(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createTask_3019(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EweVisualIDRegistry.getType(TaskEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createTaskFollows_4001(View containerView, int index,
		...
		edge.setType(EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge,
				EweVisualIDRegistry
						.getType(TaskFollowsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createTargetDepends_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(EweVisualIDRegistry
		...
		Node label6002 = createLabel(edge,
				EweVisualIDRegistry
						.getType(TargetDependsExternalLabelEditPart.VISUAL_ID));
