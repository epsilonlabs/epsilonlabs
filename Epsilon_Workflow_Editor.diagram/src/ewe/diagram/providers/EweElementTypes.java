...
public class EweElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType FlockTask_3007 = getElementType("Epsilon_Workflow_Editor.diagram.FlockTask_3007"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType EUnitTask_3008 = getElementType("Epsilon_Workflow_Editor.diagram.EUnitTask_3008"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType EclTask_3009 = getElementType("Epsilon_Workflow_Editor.diagram.EclTask_3009"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType LoadModelTask_3010 = getElementType("Epsilon_Workflow_Editor.diagram.LoadModelTask_3010"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType StoreModelTask_3011 = getElementType("Epsilon_Workflow_Editor.diagram.StoreModelTask_3011"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType RollbackTransactionTask_3012 = getElementType("Epsilon_Workflow_Editor.diagram.RollbackTransactionTask_3012"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType DisposeModelTask_3013 = getElementType("Epsilon_Workflow_Editor.diagram.DisposeModelTask_3013"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType StartTransactionTask_3014 = getElementType("Epsilon_Workflow_Editor.diagram.StartTransactionTask_3014"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType CommitTransactionTask_3015 = getElementType("Epsilon_Workflow_Editor.diagram.CommitTransactionTask_3015"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType DisposeModelsTask_3016 = getElementType("Epsilon_Workflow_Editor.diagram.DisposeModelsTask_3016"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType NestedElement_3017 = getElementType("Epsilon_Workflow_Editor.diagram.NestedElement_3017"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Task_3018 = getElementType("Epsilon_Workflow_Editor.diagram.Task_3018"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(FlockTask_3007, EwePackage.eINSTANCE.getFlockTask());

			elements.put(EUnitTask_3008, EwePackage.eINSTANCE.getEUnitTask());

			elements.put(EclTask_3009, EwePackage.eINSTANCE.getEclTask());

			elements.put(LoadModelTask_3010,
					EwePackage.eINSTANCE.getLoadModelTask());

			elements.put(StoreModelTask_3011,
					EwePackage.eINSTANCE.getStoreModelTask());

			elements.put(RollbackTransactionTask_3012,
					EwePackage.eINSTANCE.getRollbackTransactionTask());

			elements.put(DisposeModelTask_3013,
					EwePackage.eINSTANCE.getDisposeModelTask());

			elements.put(StartTransactionTask_3014,
					EwePackage.eINSTANCE.getStartTransactionTask());

			elements.put(CommitTransactionTask_3015,
					EwePackage.eINSTANCE.getCommitTransactionTask());

			elements.put(DisposeModelsTask_3016,
					EwePackage.eINSTANCE.getDisposeModelsTask());

			elements.put(NestedElement_3017,
					EwePackage.eINSTANCE.getNestedElement());

			elements.put(Task_3018, EwePackage.eINSTANCE.getTask());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(FlockTask_3007);
			KNOWN_ELEMENT_TYPES.add(EUnitTask_3008);
			KNOWN_ELEMENT_TYPES.add(EclTask_3009);
			KNOWN_ELEMENT_TYPES.add(LoadModelTask_3010);
			KNOWN_ELEMENT_TYPES.add(StoreModelTask_3011);
			KNOWN_ELEMENT_TYPES.add(RollbackTransactionTask_3012);
			KNOWN_ELEMENT_TYPES.add(DisposeModelTask_3013);
			KNOWN_ELEMENT_TYPES.add(StartTransactionTask_3014);
			KNOWN_ELEMENT_TYPES.add(CommitTransactionTask_3015);
			KNOWN_ELEMENT_TYPES.add(DisposeModelsTask_3016);
			KNOWN_ELEMENT_TYPES.add(NestedElement_3017);
			KNOWN_ELEMENT_TYPES.add(Task_3018);
