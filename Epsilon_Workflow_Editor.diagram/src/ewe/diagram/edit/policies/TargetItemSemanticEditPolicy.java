...
import ewe.diagram.edit.commands.TargetDependsCreateCommand;
import ewe.diagram.edit.commands.TargetDependsReorientCommand;
 ...
 * @generated
 */
public class TargetItemSemanticEditPolicy extends EweBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TargetItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (EweVisualIDRegistry.getVisualID(incomingLink) == TargetDependsEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (EweVisualIDRegistry.getVisualID(outgoingLink) == TargetDependsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (EweVisualIDRegistry.getVisualID(node)) {
			case TargetTargetTargetTasksCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (EweVisualIDRegistry.getVisualID(cnode)) {
					case EolTaskEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
								.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (EweVisualIDRegistry.getVisualID(incomingLink) == TaskFollowsEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
								.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (EweVisualIDRegistry.getVisualID(outgoingLink) == TaskFollowsEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (EweElementTypes.TargetDepends_4002 == req.getElementType()) {
			return getGEFWrapper(new TargetDependsCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case TargetDependsEditPart.VISUAL_ID:
			return getGEFWrapper(new TargetDependsReorientCommand(req));
		}
