 ...
 * @generated
 */
public class TaskFollowsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TaskFollowsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EweBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTaskFollows_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setFollows(getTarget());
		}
