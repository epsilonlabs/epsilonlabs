...
import ewe.diagram.edit.policies.EUnitTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EUnitTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EUnitTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EUnitTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EUnitTaskFigure();
	}

	/**
	 * @generated
	 */
	public EUnitTaskFigure getPrimaryShape() {
		return (EUnitTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EUnitTaskSrcEditPart) {
			((EUnitTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEUnitTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EUnitTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EUnitTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EUnitTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEUnitTaskLabelFigure;

		/**
		 * @generated
		 */
		public EUnitTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEUnitTaskLabelFigure = new WrappingLabel();
			fFigureEUnitTaskLabelFigure.setText("EUnitTask");

			this.add(fFigureEUnitTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEUnitTaskLabelFigure() {
			return fFigureEUnitTaskLabelFigure;
		}
