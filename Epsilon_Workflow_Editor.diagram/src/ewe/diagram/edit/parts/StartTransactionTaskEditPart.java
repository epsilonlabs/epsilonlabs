...
import ewe.diagram.edit.policies.StartTransactionTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartTransactionTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StartTransactionTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StartTransactionTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StartTransactionTaskFigure();
	}

	/**
	 * @generated
	 */
	public StartTransactionTaskFigure getPrimaryShape() {
		return (StartTransactionTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StartTransactionTaskNameEditPart) {
			((StartTransactionTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureStartTransactionTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.StartTransactionTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class StartTransactionTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureStartTransactionTaskLabelFigure;

		/**
		 * @generated
		 */
		public StartTransactionTaskFigure() {
		...
		private void createContents() {
			...
			fFigureStartTransactionTaskLabelFigure = new WrappingLabel();
			fFigureStartTransactionTaskLabelFigure
					.setText("StartTransactionTask");

			this.add(fFigureStartTransactionTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureStartTransactionTaskLabelFigure() {
			return fFigureStartTransactionTaskLabelFigure;
		}
