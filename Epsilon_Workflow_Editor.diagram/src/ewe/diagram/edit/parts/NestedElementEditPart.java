...
import ewe.diagram.edit.policies.NestedElementItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NestedElementEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NestedElementEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NestedElementItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new NestedElementFigure();
	}

	/**
	 * @generated
	 */
	public NestedElementFigure getPrimaryShape() {
		return (NestedElementFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NestedElementNameEditPart) {
			((NestedElementNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureNestedElementLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.NestedElementEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class NestedElementFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureNestedElementLabelFigure;

		/**
		 * @generated
		 */
		public NestedElementFigure() {
		...
		private void createContents() {
			...
			fFigureNestedElementLabelFigure = new WrappingLabel();
			fFigureNestedElementLabelFigure.setText("NestedElement");

			this.add(fFigureNestedElementLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureNestedElementLabelFigure() {
			return fFigureNestedElementLabelFigure;
		}
