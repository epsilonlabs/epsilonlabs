...
import ewe.diagram.edit.policies.StoreModelTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StoreModelTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StoreModelTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StoreModelTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StoreModelTaskFigure();
	}

	/**
	 * @generated
	 */
	public StoreModelTaskFigure getPrimaryShape() {
		return (StoreModelTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StoreModelTaskNameEditPart) {
			((StoreModelTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureStoreModelTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.StoreModelTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class StoreModelTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureStoreModelTaskLabelFigure;

		/**
		 * @generated
		 */
		public StoreModelTaskFigure() {
		...
		private void createContents() {
			...
			fFigureStoreModelTaskLabelFigure = new WrappingLabel();
			fFigureStoreModelTaskLabelFigure.setText("StoreModelTask");

			this.add(fFigureStoreModelTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureStoreModelTaskLabelFigure() {
			return fFigureStoreModelTaskLabelFigure;
		}
