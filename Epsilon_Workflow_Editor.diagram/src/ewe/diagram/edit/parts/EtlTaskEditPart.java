...
import ewe.diagram.edit.policies.EtlTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EtlTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EtlTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EtlTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EtlTaskFigure();
	}

	/**
	 * @generated
	 */
	public EtlTaskFigure getPrimaryShape() {
		return (EtlTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EtlTaskSrcEditPart) {
			((EtlTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEtlTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EtlTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EtlTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EtlTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEtlTaskLabelFigure;

		/**
		 * @generated
		 */
		public EtlTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEtlTaskLabelFigure = new WrappingLabel();
			fFigureEtlTaskLabelFigure.setText("EtlTask");

			this.add(fFigureEtlTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEtlTaskLabelFigure() {
			return fFigureEtlTaskLabelFigure;
		}
