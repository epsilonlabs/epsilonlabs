...
import ewe.diagram.edit.policies.EmlTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EmlTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EmlTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EmlTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EmlTaskFigure();
	}

	/**
	 * @generated
	 */
	public EmlTaskFigure getPrimaryShape() {
		return (EmlTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EmlTaskSrcEditPart) {
			((EmlTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEmlTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EmlTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EmlTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EmlTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEmlTaskLabelFigure;

		/**
		 * @generated
		 */
		public EmlTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEmlTaskLabelFigure = new WrappingLabel();
			fFigureEmlTaskLabelFigure.setText("EmlTask");

			this.add(fFigureEmlTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEmlTaskLabelFigure() {
			return fFigureEmlTaskLabelFigure;
		}
