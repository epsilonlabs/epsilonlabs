...
import ewe.diagram.edit.policies.EvlTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EvlTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EvlTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EvlTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EvlTaskFigure();
	}

	/**
	 * @generated
	 */
	public EvlTaskFigure getPrimaryShape() {
		return (EvlTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EvlTaskSrcEditPart) {
			((EvlTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEvlTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EvlTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EvlTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EvlTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEvlTaskLabelFigure;

		/**
		 * @generated
		 */
		public EvlTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEvlTaskLabelFigure = new WrappingLabel();
			fFigureEvlTaskLabelFigure.setText("EvlTask");

			this.add(fFigureEvlTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEvlTaskLabelFigure() {
			return fFigureEvlTaskLabelFigure;
		}
