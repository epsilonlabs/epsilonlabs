...
import ewe.diagram.edit.policies.CommitTransactionTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CommitTransactionTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CommitTransactionTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CommitTransactionTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CommitTransactionTaskFigure();
	}

	/**
	 * @generated
	 */
	public CommitTransactionTaskFigure getPrimaryShape() {
		return (CommitTransactionTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CommitTransactionTaskNameEditPart) {
			((CommitTransactionTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCommitTransactionTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.CommitTransactionTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class CommitTransactionTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCommitTransactionTaskLabelFigure;

		/**
		 * @generated
		 */
		public CommitTransactionTaskFigure() {
		...
		private void createContents() {
			...
			fFigureCommitTransactionTaskLabelFigure = new WrappingLabel();
			fFigureCommitTransactionTaskLabelFigure
					.setText("CommitTransactionTask");

			this.add(fFigureCommitTransactionTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCommitTransactionTaskLabelFigure() {
			return fFigureCommitTransactionTaskLabelFigure;
		}
