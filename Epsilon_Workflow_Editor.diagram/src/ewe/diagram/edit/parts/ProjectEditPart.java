...
import ewe.diagram.edit.commands.EweCreateShortcutDecorationsCommand;
import ewe.diagram.edit.policies.ProjectCanonicalEditPolicy;
import ewe.diagram.edit.policies.ProjectItemSemanticEditPolicy;
...
public class ProjectEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Ewe"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new EweCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
