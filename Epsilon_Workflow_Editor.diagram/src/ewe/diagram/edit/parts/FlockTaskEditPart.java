...
import ewe.diagram.edit.policies.FlockTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FlockTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FlockTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FlockTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FlockTaskFigure();
	}

	/**
	 * @generated
	 */
	public FlockTaskFigure getPrimaryShape() {
		return (FlockTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FlockTaskSrcEditPart) {
			((FlockTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureFlockTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(FlockTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.FlockTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class FlockTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureFlockTaskLabelFigure;

		/**
		 * @generated
		 */
		public FlockTaskFigure() {
		...
		private void createContents() {
			...
			fFigureFlockTaskLabelFigure = new WrappingLabel();
			fFigureFlockTaskLabelFigure.setText("FlockTask");

			this.add(fFigureFlockTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFlockTaskLabelFigure() {
			return fFigureFlockTaskLabelFigure;
		}
