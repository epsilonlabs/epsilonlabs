...
import ewe.diagram.edit.policies.EglTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EglTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EglTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EglTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EglTaskFigure();
	}

	/**
	 * @generated
	 */
	public EglTaskFigure getPrimaryShape() {
		return (EglTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EglTaskSrcEditPart) {
			((EglTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEglTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EglTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EglTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EglTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEglTaskLabelFigure;

		/**
		 * @generated
		 */
		public EglTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEglTaskLabelFigure = new WrappingLabel();
			fFigureEglTaskLabelFigure.setText("EglTask");

			this.add(fFigureEglTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEglTaskLabelFigure() {
			return fFigureEglTaskLabelFigure;
		}
