...
import ewe.diagram.edit.policies.DisposeModelsTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DisposeModelsTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DisposeModelsTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DisposeModelsTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DisposeModelsTaskFigure();
	}

	/**
	 * @generated
	 */
	public DisposeModelsTaskFigure getPrimaryShape() {
		return (DisposeModelsTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DisposeModelsTaskNameEditPart) {
			((DisposeModelsTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDisposeModelsTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.DisposeModelsTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class DisposeModelsTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDisposeModelsTaskLabelFigure;

		/**
		 * @generated
		 */
		public DisposeModelsTaskFigure() {
		...
		private void createContents() {
			...
			fFigureDisposeModelsTaskLabelFigure = new WrappingLabel();
			fFigureDisposeModelsTaskLabelFigure.setText("DisposeModelsTask");

			this.add(fFigureDisposeModelsTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDisposeModelsTaskLabelFigure() {
			return fFigureDisposeModelsTaskLabelFigure;
		}
