...
import ewe.diagram.edit.policies.LoadXMLModelTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoadXMLModelTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LoadXMLModelTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoadXMLModelTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LoadXMLModelTaskFigure();
	}

	/**
	 * @generated
	 */
	public LoadXMLModelTaskFigure getPrimaryShape() {
		return (LoadXMLModelTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoadXMLModelTaskNameEditPart) {
			((LoadXMLModelTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLoadXMLModelTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.LoadXMLModelTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class LoadXMLModelTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLoadXMLModelTaskLabelFigure;

		/**
		 * @generated
		 */
		public LoadXMLModelTaskFigure() {
		...
		private void createContents() {
			...
			fFigureLoadXMLModelTaskLabelFigure = new WrappingLabel();
			fFigureLoadXMLModelTaskLabelFigure.setText("LoadXMLModelTask");

			this.add(fFigureLoadXMLModelTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLoadXMLModelTaskLabelFigure() {
			return fFigureLoadXMLModelTaskLabelFigure;
		}
