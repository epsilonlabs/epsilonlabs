...
import ewe.diagram.edit.policies.EclTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EclTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EclTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EclTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EclTaskFigure();
	}

	/**
	 * @generated
	 */
	public EclTaskFigure getPrimaryShape() {
		return (EclTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EclTaskSrcEditPart) {
			((EclTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEclTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EclTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EclTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EclTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEclTaskLabelFigure;

		/**
		 * @generated
		 */
		public EclTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEclTaskLabelFigure = new WrappingLabel();
			fFigureEclTaskLabelFigure.setText("EclTask");

			this.add(fFigureEclTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEclTaskLabelFigure() {
			return fFigureEclTaskLabelFigure;
		}
