...
import ewe.diagram.edit.policies.DisposeModelTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DisposeModelTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DisposeModelTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DisposeModelTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DisposeModelTaskFigure();
	}

	/**
	 * @generated
	 */
	public DisposeModelTaskFigure getPrimaryShape() {
		return (DisposeModelTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DisposeModelTaskNameEditPart) {
			((DisposeModelTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDisposeModelTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.DisposeModelTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class DisposeModelTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDisposeModelTaskLabelFigure;

		/**
		 * @generated
		 */
		public DisposeModelTaskFigure() {
		...
		private void createContents() {
			...
			fFigureDisposeModelTaskLabelFigure = new WrappingLabel();
			fFigureDisposeModelTaskLabelFigure.setText("DisposeModelTask");

			this.add(fFigureDisposeModelTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDisposeModelTaskLabelFigure() {
			return fFigureDisposeModelTaskLabelFigure;
		}
