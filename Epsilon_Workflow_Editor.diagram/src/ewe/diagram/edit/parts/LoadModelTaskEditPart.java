...
import ewe.diagram.edit.policies.LoadModelTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LoadModelTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LoadModelTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoadModelTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LoadModelTaskFigure();
	}

	/**
	 * @generated
	 */
	public LoadModelTaskFigure getPrimaryShape() {
		return (LoadModelTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoadModelTaskNameEditPart) {
			((LoadModelTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLoadModelTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.LoadModelTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class LoadModelTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLoadModelTaskLabelFigure;

		/**
		 * @generated
		 */
		public LoadModelTaskFigure() {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLoadModelTaskLabelFigure() {
			return fFigureLoadModelTaskLabelFigure;
		}
