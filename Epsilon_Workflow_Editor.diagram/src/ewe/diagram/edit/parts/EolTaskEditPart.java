...
import ewe.diagram.edit.policies.EolTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EolTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EolTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EolTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EolTaskFigure();
	}

	/**
	 * @generated
	 */
	public EolTaskFigure getPrimaryShape() {
		return (EolTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EolTaskSrcEditPart) {
			((EolTaskSrcEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEolTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EweVisualIDRegistry
				.getType(EolTaskSrcEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.EolTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class EolTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEolTaskLabelFigure;

		/**
		 * @generated
		 */
		public EolTaskFigure() {
		...
		private void createContents() {
			...
			fFigureEolTaskLabelFigure = new WrappingLabel();
			fFigureEolTaskLabelFigure.setText("EolTask");

			this.add(fFigureEolTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEolTaskLabelFigure() {
			return fFigureEolTaskLabelFigure;
		}
