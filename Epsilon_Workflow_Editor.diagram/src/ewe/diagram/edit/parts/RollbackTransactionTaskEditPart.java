...
import ewe.diagram.edit.policies.RollbackTransactionTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RollbackTransactionTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RollbackTransactionTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RollbackTransactionTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RollbackTransactionTaskFigure();
	}

	/**
	 * @generated
	 */
	public RollbackTransactionTaskFigure getPrimaryShape() {
		return (RollbackTransactionTaskFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RollbackTransactionTaskNameEditPart) {
			((RollbackTransactionTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRollbackTransactionTaskLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ewe.diagram.edit.parts.RollbackTransactionTaskEditPart) {
			types.add(EweElementTypes.TaskFollows_4001);
		}
	 ...
	 * @generated
	 */
	public class RollbackTransactionTaskFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRollbackTransactionTaskLabelFigure;

		/**
		 * @generated
		 */
		public RollbackTransactionTaskFigure() {
		...
		private void createContents() {
			...
			fFigureRollbackTransactionTaskLabelFigure = new WrappingLabel();
			fFigureRollbackTransactionTaskLabelFigure
					.setText("RollbackTransactionTask");

			this.add(fFigureRollbackTransactionTaskLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRollbackTransactionTaskLabelFigure() {
			return fFigureRollbackTransactionTaskLabelFigure;
		}
