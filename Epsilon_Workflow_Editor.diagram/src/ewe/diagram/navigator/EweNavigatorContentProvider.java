	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case DisposeModelTaskEditPart.VISUAL_ID: {
			...
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_DisposeModelTask_3013_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_DisposeModelTask_3013_outgoinglinks,
		...
		case NestedElementEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_NestedElement_3017_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_NestedElement_3017_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case EUnitTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_EUnitTask_3008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_EUnitTask_3008_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case TaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_Task_3018_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_Task_3018_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case EclTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_EclTask_3009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_EclTask_3009_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case StartTransactionTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_StartTransactionTask_3014_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_StartTransactionTask_3014_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case LoadModelTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_LoadModelTask_3010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_LoadModelTask_3010_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case DisposeModelsTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_DisposeModelsTask_3016_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_DisposeModelsTask_3016_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case RollbackTransactionTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_RollbackTransactionTask_3012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_RollbackTransactionTask_3012_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case StoreModelTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_StoreModelTask_3011_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_StoreModelTask_3011_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case CommitTransactionTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_CommitTransactionTask_3015_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_CommitTransactionTask_3015_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
		...
		case FlockTaskEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			EweNavigatorGroup incominglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_FlockTask_3007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			EweNavigatorGroup outgoinglinks = new EweNavigatorGroup(
					Messages.NavigatorGroupName_FlockTask_3007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					EweVisualIDRegistry.getType(TaskFollowsEditPart.VISUAL_ID));
