...
public class EweNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case DisposeModelTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?DisposeModelTask", EweElementTypes.DisposeModelTask_3013); //$NON-NLS-1$
		...
		case NestedElementEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?NestedElement", EweElementTypes.NestedElement_3017); //$NON-NLS-1$
		case EUnitTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?EUnitTask", EweElementTypes.EUnitTask_3008); //$NON-NLS-1$
		case TargetEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?ewe?Target", EweElementTypes.Target_2001); //$NON-NLS-1$
		case TaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?Task", EweElementTypes.Task_3018); //$NON-NLS-1$
		...
		case EclTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?EclTask", EweElementTypes.EclTask_3009); //$NON-NLS-1$
		case StartTransactionTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?StartTransactionTask", EweElementTypes.StartTransactionTask_3014); //$NON-NLS-1$
		case LoadModelTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?LoadModelTask", EweElementTypes.LoadModelTask_3010); //$NON-NLS-1$
		case DisposeModelsTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?DisposeModelsTask", EweElementTypes.DisposeModelsTask_3016); //$NON-NLS-1$
		...
		case RollbackTransactionTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?RollbackTransactionTask", EweElementTypes.RollbackTransactionTask_3012); //$NON-NLS-1$
		...
		case StoreModelTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?StoreModelTask", EweElementTypes.StoreModelTask_3011); //$NON-NLS-1$
		...
		case CommitTransactionTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?CommitTransactionTask", EweElementTypes.CommitTransactionTask_3015); //$NON-NLS-1$
		case FlockTaskEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?ewe?FlockTask", EweElementTypes.FlockTask_3007); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		switch (EweVisualIDRegistry.getVisualID(view)) {
		case DisposeModelTaskEditPart.VISUAL_ID:
			return getDisposeModelTask_3013Text(view);
		case TargetDependsEditPart.VISUAL_ID:
			return getTargetDepends_4002Text(view);
		case NestedElementEditPart.VISUAL_ID:
			return getNestedElement_3017Text(view);
		case EUnitTaskEditPart.VISUAL_ID:
			return getEUnitTask_3008Text(view);
		case TargetEditPart.VISUAL_ID:
			return getTarget_2001Text(view);
		case TaskEditPart.VISUAL_ID:
			return getTask_3018Text(view);
		case EmlTaskEditPart.VISUAL_ID:
			return getEmlTask_3002Text(view);
		case EclTaskEditPart.VISUAL_ID:
			return getEclTask_3009Text(view);
		case StartTransactionTaskEditPart.VISUAL_ID:
			return getStartTransactionTask_3014Text(view);
		case LoadModelTaskEditPart.VISUAL_ID:
			return getLoadModelTask_3010Text(view);
		case DisposeModelsTaskEditPart.VISUAL_ID:
			return getDisposeModelsTask_3016Text(view);
		case EtlTaskEditPart.VISUAL_ID:
			return getEtlTask_3004Text(view);
		case RollbackTransactionTaskEditPart.VISUAL_ID:
			return getRollbackTransactionTask_3012Text(view);
		case TaskFollowsEditPart.VISUAL_ID:
			return getTaskFollows_4001Text(view);
		case EglTaskEditPart.VISUAL_ID:
			return getEglTask_3003Text(view);
		case StoreModelTaskEditPart.VISUAL_ID:
			return getStoreModelTask_3011Text(view);
		case EolTaskEditPart.VISUAL_ID:
			return getEolTask_3001Text(view);
		case EvlTaskEditPart.VISUAL_ID:
			return getEvlTask_3005Text(view);
		case CommitTransactionTaskEditPart.VISUAL_ID:
			return getCommitTransactionTask_3015Text(view);
		case FlockTaskEditPart.VISUAL_ID:
			return getFlockTask_3007Text(view);
		case LoadEMFModelTaskEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getDisposeModelTask_3013Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.DisposeModelTask_3013,
	 ...
	 * @generated
	 */
	private String getNestedElement_3017Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.NestedElement_3017,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getEUnitTask_3008Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.EUnitTask_3008,
				view.getElement() != null ? view.getElement() : view,
	 ...
	 * @generated
	 */
	private String getTask_3018Text(View view) {
		IParser parser = EweParserProvider.getParser(EweElementTypes.Task_3018,
				view.getElement() != null ? view.getElement() : view,
	 ...
	 * @generated
	 */
	private String getEclTask_3009Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.EclTask_3009,
				view.getElement() != null ? view.getElement() : view,
	 ...
	 * @generated
	 */
	private String getStartTransactionTask_3014Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.StartTransactionTask_3014,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getLoadModelTask_3010Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.LoadModelTask_3010,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getDisposeModelsTask_3016Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.DisposeModelsTask_3016,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getRollbackTransactionTask_3012Text(View view) {
		IParser parser = EweParserProvider
				.getParser(
						EweElementTypes.RollbackTransactionTask_3012,
						view.getElement() != null ? view.getElement() : view,
						EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getStoreModelTask_3011Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.StoreModelTask_3011,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getCommitTransactionTask_3015Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.CommitTransactionTask_3015,
				view.getElement() != null ? view.getElement() : view,
				EweVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getFlockTask_3007Text(View view) {
		IParser parser = EweParserProvider.getParser(
				EweElementTypes.FlockTask_3007,
				view.getElement() != null ? view.getElement() : view,
