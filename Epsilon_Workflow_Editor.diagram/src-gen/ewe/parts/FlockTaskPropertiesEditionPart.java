 ...
 * 
 */
public interface FlockTaskPropertiesEditionPart {
	...
	/**
	 * Defines a new originalModel
	 * @param newValue the new originalModel to set
	 * 
	 */
	...
	/**
	 * @return the migratedModel
	 * 
	 */
	public String getMigratedModel();

	/**
	 * Defines a new migratedModel
	 * @param newValue the new migratedModel to set
	 * 
	 */
