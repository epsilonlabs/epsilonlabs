...
protected List<ViewerFilter> taskElementsFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createTaskElementsAdvancedTableComposition(Composite parent) {
		this.taskElements = new ReferencesTable(EweMessages.TaskPropertiesEditionPart_TaskElementsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this, EweViewsRepository.Task.Properties.taskElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				taskElements.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this, EweViewsRepository.Task.Properties.taskElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				taskElements.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this, EweViewsRepository.Task.Properties.taskElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				taskElements.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this, EweViewsRepository.Task.Properties.taskElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				taskElements.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.taskElements.setHelpText(propertiesEditionComponent.getHelpContent(EweViewsRepository.Task.Properties.taskElements, EweViewsRepository.SWT_KIND));
		this.taskElements.createControls(parent);
		this.taskElements.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this, EweViewsRepository.Task.Properties.taskElements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
