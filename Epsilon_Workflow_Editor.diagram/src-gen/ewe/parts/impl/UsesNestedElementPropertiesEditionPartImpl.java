 ...
 * 
 */
public class UsesNestedElementPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, UsesNestedElementPropertiesEditionPart {
	 ...
	 * 
	 */
	public UsesNestedElementPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EweMessages.UsesNestedElementPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createRefText(Composite parent) {
		SWTUtils.createPartLabel(parent, EweMessages.UsesNestedElementPropertiesEditionPart_RefLabel, propertiesEditionComponent.isRequired(EweViewsRepository.UsesNestedElement.Properties.ref, EweViewsRepository.SWT_KIND));
		...
		ref.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UsesNestedElementPropertiesEditionPartImpl.this, EweViewsRepository.UsesNestedElement.Properties.ref, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, ref.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EweViewsRepository.UsesNestedElement.Properties.ref, EweViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createAsText(Composite parent) {
		SWTUtils.createPartLabel(parent, EweMessages.UsesNestedElementPropertiesEditionPart_AsLabel, propertiesEditionComponent.isRequired(EweViewsRepository.UsesNestedElement.Properties.as, EweViewsRepository.SWT_KIND));
		...
		as.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UsesNestedElementPropertiesEditionPartImpl.this, EweViewsRepository.UsesNestedElement.Properties.as, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, as.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EweViewsRepository.UsesNestedElement.Properties.as, EweViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOptionalText(Composite parent) {
		SWTUtils.createPartLabel(parent, EweMessages.UsesNestedElementPropertiesEditionPart_OptionalLabel, propertiesEditionComponent.isRequired(EweViewsRepository.UsesNestedElement.Properties.optional, EweViewsRepository.SWT_KIND));
		...
		optional.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(UsesNestedElementPropertiesEditionPartImpl.this, EweViewsRepository.UsesNestedElement.Properties.optional, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, optional.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EweViewsRepository.UsesNestedElement.Properties.optional, EweViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
