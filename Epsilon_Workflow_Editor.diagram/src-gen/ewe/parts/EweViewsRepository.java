...
public class EweViewsRepository {
	...
	public static class Property {
		public static class Properties {
			...
			public static String name = "ewe::Property::properties::name";
	...
	/**
	 * LoadXMLModelTask view descriptor
	 * 
	 */
	public static class LoadXMLModelTask {
		public static class Properties {
	
			
			public static String name = "ewe::LoadXMLModelTask::properties::name";
			
			
			public static String type = "ewe::LoadXMLModelTask::properties::type";
			
			
			public static String file = "ewe::LoadXMLModelTask::properties::file";
			
			
			public static String uri = "ewe::LoadXMLModelTask::properties::uri";
