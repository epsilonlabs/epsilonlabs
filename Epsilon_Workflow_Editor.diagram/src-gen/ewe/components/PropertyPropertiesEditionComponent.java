...
public class PropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public PropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject property, String editing_mode) {
		...
		partKey = EweViewsRepository.Property.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (property.getName() != null && isAccessible(EweViewsRepository.Property.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), property.getName()));
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EweViewsRepository.Property.Properties.name) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EweViewsRepository.Property.Properties.name == event.getAffectedEditor()) {
			property.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (EwePackage.eINSTANCE.getTask_Name().equals(msg.getFeature()) && basePart != null && isAccessible(EweViewsRepository.Property.Properties.name)) {
