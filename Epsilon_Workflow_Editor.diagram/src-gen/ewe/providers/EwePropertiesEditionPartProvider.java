...
import ewe.parts.forms.LoadXMLModelTaskPropertiesEditionPartForm;
...
import ewe.parts.forms.PropertyPropertiesEditionPartForm;
...
import ewe.parts.impl.LoadXMLModelTaskPropertiesEditionPartImpl;
...
import ewe.parts.impl.PropertyPropertiesEditionPartImpl;
...
public class EwePropertiesEditionPartProvider implements IPropertiesEditionPartProvider {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(Object key, int kind, IPropertiesEditionComponent component) {
		...
		if (key == EweViewsRepository.Property.class) {
			if (kind == EweViewsRepository.SWT_KIND)
		...
		if (key == EweViewsRepository.LoadXMLModelTask.class) {
			if (kind == EweViewsRepository.SWT_KIND)
				return new LoadXMLModelTaskPropertiesEditionPartImpl(component);
			if (kind == EweViewsRepository.FORM_KIND)
				return new LoadXMLModelTaskPropertiesEditionPartForm(component);
		}
