 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.metamodel.impl.BooleanExpressionImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpressionImpl extends PrimitiveExpressionImpl implements BooleanExpression {
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EolPackage.BOOLEAN_EXPRESSION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EolPackage.BOOLEAN_EXPRESSION__VALUE:
				return isValue();
		}
