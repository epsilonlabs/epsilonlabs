...
public class RssPackageImpl extends EPackageImpl implements RssPackage {
	 ...
	 * @generated
	 */
	public EReference getRss_Channels() {
		return (EReference)rssEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getChannel_Link() {
	 ...
	 * @generated
	 */
	public EAttribute getChannel_Language() {
	 ...
	 * @generated
	 */
	public EReference getChannel_Image() {
	 ...
	 * @generated
	 */
	public EReference getChannel_Items() {
	...
	public void createPackageContents() {
		...
		createEReference(rssEClass, RSS__CHANNELS);

		channelEClass = createEClass(CHANNEL);
		createEAttribute(channelEClass, CHANNEL__TITLE);
		createEAttribute(channelEClass, CHANNEL__LINK);
		createEAttribute(channelEClass, CHANNEL__DESCRIPTION);
		createEAttribute(channelEClass, CHANNEL__LANGUAGE);
		createEReference(channelEClass, CHANNEL__IMAGE);
		createEReference(channelEClass, CHANNEL__ITEMS);
		...
		createEAttribute(itemEClass, ITEM__LINK);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(rssEClass, Rss.class, "Rss", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRss_Channels(), this.getChannel(), null, "channels", null, 0, -1, Rss.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getChannel_Link(), ecorePackage.getEString(), "link", null, 0, 1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getChannel_Language(), ecorePackage.getEString(), "language", null, 0, 1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChannel_Image(), this.getImage(), null, "image", null, 0, 1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChannel_Items(), this.getItem(), null, "items", null, 0, -1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getItem_Link(), ecorePackage.getEString(), "link", null, 0, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
