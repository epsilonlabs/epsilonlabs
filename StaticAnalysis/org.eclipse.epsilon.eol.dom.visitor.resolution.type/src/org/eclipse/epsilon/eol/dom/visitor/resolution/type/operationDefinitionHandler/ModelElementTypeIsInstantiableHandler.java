...
public class ModelElementTypeIsInstantiableHandler extends ModelElementTypeHandler{

	public ModelElementTypeIsInstantiableHandler(TypeResolutionContext context) {
		super(context);
