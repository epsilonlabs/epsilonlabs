...
public class CollectionCloneOperationHandler extends CollectionOperationDefinitionHandler {

	public CollectionCloneOperationHandler(TypeResolutionContext context) {
		super(context);
