...
public class CollectionInvertOperationHandler extends CollectionOperationDefinitionHandler{

	public CollectionInvertOperationHandler(TypeResolutionContext context) {
		super(context);
