...
public class CollectionIndexOfOperationHandler extends CollectionOperationDefinitionHandler{

	public CollectionIndexOfOperationHandler(TypeResolutionContext context) {
		super(context);
