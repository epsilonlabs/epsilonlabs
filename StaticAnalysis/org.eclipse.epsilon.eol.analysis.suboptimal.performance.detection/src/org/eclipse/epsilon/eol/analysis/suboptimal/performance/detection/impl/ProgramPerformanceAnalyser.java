package org.eclipse.epsilon.eol.analysis.suboptimal.performance.detection.impl;
...
import org.eclipse.epsilon.eol.analysis.suboptimal.performance.detection.context.SuboptimalDetectionContext;
...
public class ProgramPerformanceAnalyser {
	...
	public void matchSelectPatterOne(EolProgram program) throws Exception
	{
	...
	public void matchSelectPatterTwo(EolProgram program) throws Exception
	{
		EplModule module = new EplModule();
		...
		for(PatternMatch pm : patternMatchModel.getMatches())
		{
			...
			context.getLogBook().addWarning(fol, "Sub-optimal expression, consider rewriting as: "+ printer.print(targetfol.getTarget()) + ".select("+ targetfol.getIterator().getName().getName() + "|" +  printer.print(targetfol.getCondition()) + "and" + printer.print(fol.getCondition()) + ")");
		}
		System.out.println(patternMatchModel.getAllOfKind("PatternTwo").size());
	}
	
	public void matchSelectPatterThree(EolProgram program) throws Exception
	{
		EplModule module = new EplModule();
		...
		for(PatternMatch pm : patternMatchModel.getMatches())
		{
			...
			context.getLogBook().addWarning(fol, "Expression should be read as: "+ printer.print(fol.getTarget()) + ".selectOne("+ fol.getIterator().getName().getName() + "|" + printer.print(fol.getCondition()) + ")");
		}
		System.out.println(patternMatchModel.getAllOfKind("PatternThree").size());
	}
	
	public void matchSelectPatterFour(EolProgram program) throws Exception
	{
		EplModule module = new EplModule();
		...
		for(PatternMatch pm : patternMatchModel.getMatches())
		{
			...
			context.getLogBook().addWarning(binaryOperatorExpression, "Expression should be read as: "+ printer.print(fol.getTarget()) + ".exists("+ fol.getIterator().getName().getName() + "|" + printer.print(fol.getCondition()) + ")");
		}
		System.out.println(patternMatchModel.getAllOfKind("PatternFour").size());
	}
	
	public void matchSelectPatterFive(EolProgram program) throws Exception
	{
		EplModule module = new EplModule();
		...
		for(PatternMatch pm : patternMatchModel.getMatches())
		{
			...
			context.getLogBook().addWarning(methodCallExpression, "Expression should be read as: "+ printer.print(fol.getTarget()) + ".selectOne("+ fol.getIterator().getName().getName() + "|" + printer.print(fol.getCondition()) + ")");
		}
