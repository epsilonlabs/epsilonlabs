 ...
 *   <li>{@link org.eclipse.epsilon.evl.metamodel.impl.InvariantImpl#getFix <em>Fix</em>}</li>
...
public abstract class InvariantImpl extends GuardedElementImpl implements Invariant {
	...
	/**
	 * The cached value of the '{@link #getFix() <em>Fix</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFix()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<Fix> getFix() {
		if (fix == null) {
			fix = new EObjectContainmentEList<Fix>(Fix.class, this, EvlPackage.INVARIANT__FIX);
		}
		return fix;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EvlPackage.INVARIANT__FIX:
				return ((InternalEList<?>)getFix()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EvlPackage.INVARIANT__FIX:
				getFix().clear();
				getFix().addAll((Collection<? extends Fix>)newValue);
				return;
			case EvlPackage.INVARIANT__CHECK:
