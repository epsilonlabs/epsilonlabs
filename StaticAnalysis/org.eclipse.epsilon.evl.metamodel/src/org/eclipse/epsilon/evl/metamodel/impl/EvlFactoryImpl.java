...
public class EvlFactoryImpl extends EFactoryImpl implements EvlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EvlPackage.EVL_PROGRAM: return createEvlProgram();
			...
			case EvlPackage.PRE_BLOCK: return createPreBlock();
			case EvlPackage.POST_BLOCK: return createPostBlock();
			default:
	 ...
	 * @generated
	 */
	public EvlProgram createEvlProgram() {
		EvlProgramImpl evlProgram = new EvlProgramImpl();
		return evlProgram;
	}
