...
public interface EvlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__CONTAINER = EolPackage.EOL_LIBRARY_MODULE__CONTAINER;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__LINE = EolPackage.EOL_LIBRARY_MODULE__LINE;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__COLUMN = EolPackage.EOL_LIBRARY_MODULE__COLUMN;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__URI = EolPackage.EOL_LIBRARY_MODULE__URI;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__REGION = EolPackage.EOL_LIBRARY_MODULE__REGION;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__MODEL_DECLARATIONS = EolPackage.EOL_LIBRARY_MODULE__MODEL_DECLARATIONS;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__IMPORTS = EolPackage.EOL_LIBRARY_MODULE__IMPORTS;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__OPERATIONS = EolPackage.EOL_LIBRARY_MODULE__OPERATIONS;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__NAME = EolPackage.EOL_LIBRARY_MODULE__NAME;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__CONTEXTS = EolPackage.EOL_LIBRARY_MODULE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__PRE_BLOCKS = EolPackage.EOL_LIBRARY_MODULE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM__POST_BLOCKS = EolPackage.EOL_LIBRARY_MODULE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EVL_PROGRAM_FEATURE_COUNT = EolPackage.EOL_LIBRARY_MODULE_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.epsilon.evl.metamodel.EvlProgram#getPreBlocks <em>Pre Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Pre Blocks</em>'.
	 * @see org.eclipse.epsilon.evl.metamodel.EvlProgram#getPreBlocks()
	 * @see #getEvlProgram()
	 * @generated
	 */
	EReference getEvlProgram_PreBlocks();

	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.epsilon.evl.metamodel.EvlProgram#getPostBlocks <em>Post Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Post Blocks</em>'.
	 * @see org.eclipse.epsilon.evl.metamodel.EvlProgram#getPostBlocks()
	 * @see #getEvlProgram()
	 * @generated
	 */
	EReference getEvlProgram_PostBlocks();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference EVL_PROGRAM__PRE_BLOCKS = eINSTANCE.getEvlProgram_PreBlocks();
		 ...
		 * @generated
		 */
		EReference EVL_PROGRAM__POST_BLOCKS = eINSTANCE.getEvlProgram_PostBlocks();
