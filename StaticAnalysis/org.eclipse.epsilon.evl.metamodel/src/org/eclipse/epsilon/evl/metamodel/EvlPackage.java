...
public interface EvlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONTEXT__PRE_BLOCKS = GUARDED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CONTEXT__POST_BLOCKS = GUARDED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CONTEXT__INVARIANTS = GUARDED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int CONTEXT_FEATURE_COUNT = GUARDED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int INVARIANT__FIXES = GUARDED_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.epsilon.evl.metamodel.Context#getPreBlocks <em>Pre Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Pre Blocks</em>'.
	 * @see org.eclipse.epsilon.evl.metamodel.Context#getPreBlocks()
	 * @see #getContext()
	 * @generated
	 */
	EReference getContext_PreBlocks();

	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.epsilon.evl.metamodel.Context#getPostBlocks <em>Post Blocks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Post Blocks</em>'.
	 * @see org.eclipse.epsilon.evl.metamodel.Context#getPostBlocks()
	 * @see #getContext()
	 * @generated
	 */
	EReference getContext_PostBlocks();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference CONTEXT__PRE_BLOCKS = eINSTANCE.getContext_PreBlocks();
		 ...
		 * @generated
		 */
		EReference CONTEXT__POST_BLOCKS = eINSTANCE.getContext_PostBlocks();
