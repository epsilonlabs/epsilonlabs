...
public class EvlPackageImpl extends EPackageImpl implements EvlPackage {
	 ...
	 * @generated
	 */
	public EReference getEvlProgram_Imports() {
	 ...
	 * @generated
	 */
	public EReference getEvlProgram_Operations() {
	 ...
	 * @generated
	 */
	public EReference getEvlProgram_Name() {
	 ...
	 * @generated
	 */
	public EReference getEvlProgram_ModelDeclarations() {
		return (EReference)evlProgramEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getEvlProgram_Contexts() {
		return (EReference)evlProgramEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getContext_Pre() {
	 ...
	 * @generated
	 */
	public EReference getContext_Post() {
	 ...
	 * @generated
	 */
	public EReference getInvariant_Fix() {
	...
	public void createPackageContents() {
		...
		createEReference(evlProgramEClass, EVL_PROGRAM__IMPORTS);
		createEReference(evlProgramEClass, EVL_PROGRAM__OPERATIONS);
		createEReference(evlProgramEClass, EVL_PROGRAM__NAME);
		createEReference(evlProgramEClass, EVL_PROGRAM__MODEL_DECLARATIONS);
		...
		createEReference(contextEClass, CONTEXT__PRE);
		createEReference(contextEClass, CONTEXT__POST);
		...
		createEReference(invariantEClass, INVARIANT__FIX);
	...
	public void initializePackageContents() {
		...
		evlProgramEClass.getESuperTypes().add(this.getEvlElement());
		...
		initEReference(getEvlProgram_Imports(), theEolPackage.getImport(), null, "imports", null, 0, -1, EvlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEvlProgram_Operations(), theEolPackage.getOperationDefinition(), null, "operations", null, 0, -1, EvlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEvlProgram_Name(), theEolPackage.getNameExpression(), null, "name", null, 1, 1, EvlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEvlProgram_ModelDeclarations(), theEolPackage.getModelDeclarationStatement(), null, "modelDeclarations", null, 0, -1, EvlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContext_Pre(), this.getPreBlock(), null, "pre", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContext_Post(), this.getPostBlock(), null, "post", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInvariant_Fix(), this.getFix(), null, "fix", null, 0, -1, Invariant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
