...
public class EvlAdapterFactory extends AdapterFactoryImpl {
	...
	protected EvlSwitch<Adapter> modelSwitch =
		new EvlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEvlProgram(EvlProgram object) {
				return createEvlProgramAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.evl.metamodel.EvlProgram <em>Program</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEvlProgramAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.evl.metamodel.PreBlock <em>Pre Block</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.evl.metamodel.PostBlock <em>Post Block</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
