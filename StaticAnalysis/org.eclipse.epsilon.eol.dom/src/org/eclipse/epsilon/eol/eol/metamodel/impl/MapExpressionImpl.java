 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.eol.metamodel.impl.MapExpressionImpl#getKeyValues <em>Key Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapExpressionImpl extends LiteralExpressionImpl implements MapExpression {
	/**
	...
	public EList<KeyValue> getKeyValues() {
		if (keyValues == null) {
			keyValues = new EObjectContainmentEList<KeyValue>(KeyValue.class, this, EolPackage.MAP_EXPRESSION__KEY_VALUES);
		}
		return keyValues;
	}
