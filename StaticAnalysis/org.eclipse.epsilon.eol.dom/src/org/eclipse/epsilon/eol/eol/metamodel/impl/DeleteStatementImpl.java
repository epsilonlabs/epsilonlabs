 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.eol.metamodel.impl.DeleteStatementImpl#getDeleted <em>Deleted</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeleteStatementImpl extends StatementImpl implements DeleteStatement {
	...
	protected EClass eStaticClass() {
		return EolPackage.Literals.DELETE_STATEMENT;
	}
	...
	public NotificationChain basicSetDeleted(Expression newDeleted, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EolPackage.DELETE_STATEMENT__DELETED, oldDeleted, newDeleted);
	...
	public void setDeleted(Expression newDeleted) {
		if (newDeleted != deleted) {
			...
			if (deleted != null)
				msgs = ((InternalEObject)deleted).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EolPackage.DELETE_STATEMENT__DELETED, null, msgs);
			if (newDeleted != null)
				msgs = ((InternalEObject)newDeleted).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EolPackage.DELETE_STATEMENT__DELETED, null, msgs);
			msgs = basicSetDeleted(newDeleted, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EolPackage.DELETE_STATEMENT__DELETED, newDeleted, newDeleted));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EolPackage.DELETE_STATEMENT__DELETED:
