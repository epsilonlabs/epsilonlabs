 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.eol.metamodel.impl.EnumerationLiteralExpressionImpl#getEnumeration <em>Enumeration</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.eol.metamodel.impl.EnumerationLiteralExpressionImpl#getLiteral <em>Literal</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.eol.metamodel.impl.EnumerationLiteralExpressionImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationLiteralExpressionImpl extends ExpressionImpl implements EnumerationLiteralExpression {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModel(ModelExpression newModel, NotificationChain msgs) {
		ModelExpression oldModel = model;
		model = newModel;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setModel(ModelExpression newModel) {
		if (newModel != model) {
			NotificationChain msgs = null;
			if (model != null)
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EolPackage.ENUMERATION_LITERAL_EXPRESSION__LITERAL:
				...
				return;
			case EolPackage.ENUMERATION_LITERAL_EXPRESSION__MODEL:
				setModel((ModelExpression)newValue);
				return;
		}
