 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ReturnStatementImpl#getReturned <em>Returned</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReturnStatementImpl extends StatementImpl implements ReturnStatement {
	...
	public NotificationChain basicSetReturned(Expression newReturned, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomPackage.RETURN_STATEMENT__RETURNED, oldReturned, newReturned);
	...
	public void setReturned(Expression newReturned) {
		if (newReturned != returned) {
			...
			if (returned != null)
				msgs = ((InternalEObject)returned).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomPackage.RETURN_STATEMENT__RETURNED, null, msgs);
			if (newReturned != null)
				msgs = ((InternalEObject)newReturned).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomPackage.RETURN_STATEMENT__RETURNED, null, msgs);
			msgs = basicSetReturned(newReturned, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomPackage.RETURN_STATEMENT__RETURNED, newReturned, newReturned));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomPackage.RETURN_STATEMENT__RETURNED:
