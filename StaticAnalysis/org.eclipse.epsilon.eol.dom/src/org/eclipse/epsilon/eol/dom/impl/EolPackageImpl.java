...
public class EolPackageImpl extends EPackageImpl implements EolPackage {
	 ...
	 * @generated
	 */
	public EReference getImport_Program() {
	...
	public void createPackageContents() {
		...
		createEReference(importEClass, IMPORT__PROGRAM);
	...
	public void initializePackageContents() {
		...
		initEReference(getProgram_Imports(), this.getImport(), this.getImport_Program(), "imports", null, 0, -1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImport_Program(), this.getProgram(), this.getProgram_Imports(), "program", null, 0, 1, Import.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
