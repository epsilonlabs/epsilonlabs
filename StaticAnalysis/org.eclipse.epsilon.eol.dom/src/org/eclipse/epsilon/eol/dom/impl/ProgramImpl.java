 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getImportedModules <em>Imported Modules</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.ProgramImpl#getModelDeclarations <em>Model Declarations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProgramImpl extends DomElementImpl implements Program {
	/**
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentWithInverseEList<Import>(Import.class, this, EolPackage.PROGRAM__IMPORTS, EolPackage.IMPORT__PROGRAM);
		}
		return imports;
	}
