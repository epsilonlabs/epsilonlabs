...
public class DomAdapterFactory extends AdapterFactoryImpl {
	...
	protected DomSwitch<Adapter> modelSwitch =
		new DomSwitch<Adapter>() {
			...
			@Override
			public Adapter caseModelDeclarationExpression(ModelDeclarationExpression object) {
				return createModelDeclarationExpressionAdapter();
			}
			@Override
			public Adapter caseFLOMethodCallExpression(FLOMethodCallExpression object) {
				return createFLOMethodCallExpressionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.eol.dom.DomElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.eol.dom.ModelDeclarationExpression <em>Model Declaration Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createModelDeclarationExpressionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.eol.dom.FLOMethodCallExpression <em>FLO Method Call Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFLOMethodCallExpressionAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.epsilon.eol.dom.AnyExpression <em>Any Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
