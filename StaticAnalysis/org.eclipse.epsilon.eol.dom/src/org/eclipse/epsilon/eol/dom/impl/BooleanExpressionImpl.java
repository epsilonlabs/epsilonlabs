 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.BooleanExpressionImpl#isVal <em>Val</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpressionImpl extends PrimitiveExpressionImpl implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return DomPackage.Literals.BOOLEAN_EXPRESSION;
	}
	...
	public void setVal(boolean newVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomPackage.BOOLEAN_EXPRESSION__VAL, oldVal, val));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomPackage.BOOLEAN_EXPRESSION__VAL:
				return isVal();
		}
