 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.eol.dom.impl.CollectionExpressionImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CollectionExpressionImpl extends LiteralExpressionImpl implements CollectionExpression {
	...
	protected EClass eStaticClass() {
		return DomPackage.Literals.COLLECTION_EXPRESSION;
	}
	...
	public EList<Expression> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Expression>(Expression.class, this, DomPackage.COLLECTION_EXPRESSION__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomPackage.COLLECTION_EXPRESSION__VALUES:
