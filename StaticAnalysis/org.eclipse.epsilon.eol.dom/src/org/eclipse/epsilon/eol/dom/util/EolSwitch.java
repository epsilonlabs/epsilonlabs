	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EolPackage.ORDERED_COLLECTION_TYPE: {
				...
				if (result == null) result = caseDomElement(orderedCollectionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EolPackage.UNIQUE_COLLECTION_TYPE: {
				...
				if (result == null) result = caseDomElement(uniqueCollectionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EolPackage.SELF_INNERMOST_TYPE: {
				...
				if (result == null) result = caseDomElement(selfInnermostType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EolPackage.OPERATION_ARG_TYPE: {
				...
				if (result == null) result = caseDomElement(operationArgType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
