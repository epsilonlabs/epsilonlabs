...
public class SatisfiesOneHandler extends AnyOperationDefinitionHandler{
	...
	public SatisfiesOneHandler(TypeResolutionContext context) {
		super(context);
	...
	public boolean appliesTo(String name, ArrayList<Type> argTypes) {
		...
		return name.equals("satisfiesOne");
	}
	...
	public OperationDefinition handle(
		...
		if (mce.getArguments().size() != 1) {
			context.getLogBook().addError(mce, "operation satisfiesOne() must have only one arugment as a sequence");
		}
		else {
