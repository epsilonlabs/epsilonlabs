...
public class GuardImpl extends EtlElementImpl implements Guard {
	 ...
	 * @ordered
	 */
	protected ExpressionOrStatementBlock condition;
	 ...
	 * @generated
	 */
	public ExpressionOrStatementBlock getCondition() {
		return condition;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCondition(ExpressionOrStatementBlock newCondition, NotificationChain msgs) {
		ExpressionOrStatementBlock oldCondition = condition;
	 ...
	 * @generated
	 */
	public void setCondition(ExpressionOrStatementBlock newCondition) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EtlPackage.GUARD__CONDITION:
				setCondition((ExpressionOrStatementBlock)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case EtlPackage.GUARD__CONDITION:
				setCondition((ExpressionOrStatementBlock)null);
				return;
		}
