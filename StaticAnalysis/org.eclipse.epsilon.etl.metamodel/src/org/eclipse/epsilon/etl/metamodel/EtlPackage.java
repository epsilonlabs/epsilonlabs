...
public interface EtlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Resolved Rule Dependencies</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int RULE_DEPENDENCY__LINE = ETL_ELEMENT__LINE;
	 ...
	 * @ordered
	 */
	int RULE_DEPENDENCY__COLUMN = ETL_ELEMENT__COLUMN;
	...
	/**
	 * Returns the meta object for the reference list '{@link org.eclipse.epsilon.etl.metamodel.TransformationRule#getResolvedRuleDependencies <em>Resolved Rule Dependencies</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Resolved Rule Dependencies</em>'.
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Resolved Rule Dependencies</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
