...
public class TransformationRuleImpl extends EtlElementImpl implements TransformationRule {
	...
	/**
	 * The cached value of the '{@link #getResolvedRuleDependencies() <em>Resolved Rule Dependencies</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<RuleDependency> getResolvedRuleDependencies() {
		if (resolvedRuleDependencies == null) {
			resolvedRuleDependencies = new EObjectResolvingEList<RuleDependency>(RuleDependency.class, this, EtlPackage.TRANSFORMATION_RULE__RESOLVED_RULE_DEPENDENCIES);
		}
