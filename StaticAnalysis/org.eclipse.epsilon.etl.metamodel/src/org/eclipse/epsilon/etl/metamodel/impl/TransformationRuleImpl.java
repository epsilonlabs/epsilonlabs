 ...
 *   <li>{@link org.eclipse.epsilon.etl.metamodel.impl.TransformationRuleImpl#getDependingRules <em>Depending Rules</em>}</li>
...
public class TransformationRuleImpl extends EtlElementImpl implements TransformationRule {
	...
	/**
	 * The cached value of the '{@link #getDependingRules() <em>Depending Rules</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDependingRules()
	 * @generated
	 * @ordered
	 */
	protected EList<TransformationRule> dependingRules;
	 ...
	 * @generated
	 */
	public EList<TransformationRule> getDependingRules() {
		if (dependingRules == null) {
			dependingRules = new EObjectResolvingEList<TransformationRule>(TransformationRule.class, this, EtlPackage.TRANSFORMATION_RULE__DEPENDING_RULES);
		}
		return dependingRules;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EtlPackage.TRANSFORMATION_RULE__DEPENDING_RULES:
				return getDependingRules();
			case EtlPackage.TRANSFORMATION_RULE__GUARD:
				return getGuard();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EtlPackage.TRANSFORMATION_RULE__RESOLVED_PARENT_RULES:
				...
				return;
			case EtlPackage.TRANSFORMATION_RULE__DEPENDING_RULES:
				getDependingRules().clear();
				getDependingRules().addAll((Collection<? extends TransformationRule>)newValue);
				return;
			case EtlPackage.TRANSFORMATION_RULE__GUARD:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case EtlPackage.TRANSFORMATION_RULE__DEPENDING_RULES:
				return dependingRules != null && !dependingRules.isEmpty();
			case EtlPackage.TRANSFORMATION_RULE__GUARD:
				return guard != null;
		}
