...
public class EtlPackageImpl extends EPackageImpl implements EtlPackage {
	 ...
	 * @generated
	 */
	public EReference getEtlProgram_Imports() {
	 ...
	 * @generated
	 */
	public EReference getEtlProgram_Operations() {
	 ...
	 * @generated
	 */
	public EReference getEtlProgram_Name() {
	 ...
	 * @generated
	 */
	public EReference getEtlProgram_ModelDeclarations() {
		return (EReference)etlProgramEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getEtlProgram_TransformationRules() {
		return (EReference)etlProgramEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getEtlProgram_PreBlocks() {
		return (EReference)etlProgramEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getEtlProgram_PostBlocks() {
		return (EReference)etlProgramEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEReference(etlProgramEClass, ETL_PROGRAM__IMPORTS);
		createEReference(etlProgramEClass, ETL_PROGRAM__OPERATIONS);
		createEReference(etlProgramEClass, ETL_PROGRAM__NAME);
		createEReference(etlProgramEClass, ETL_PROGRAM__MODEL_DECLARATIONS);
	...
	public void initializePackageContents() {
		...
		etlProgramEClass.getESuperTypes().add(this.getEtlElement());
		...
		initEReference(getGuard_Condition(), theEolPackage.getEolElement(), null, "condition", null, 1, 1, Guard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(etlProgramEClass, EtlProgram.class, "EtlProgram", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEtlProgram_Imports(), theEolPackage.getImport(), null, "imports", null, 0, -1, EtlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEtlProgram_Operations(), theEolPackage.getOperationDefinition(), null, "operations", null, 0, -1, EtlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEtlProgram_Name(), theEolPackage.getNameExpression(), null, "name", null, 1, 1, EtlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEtlProgram_ModelDeclarations(), theEolPackage.getModelDeclarationStatement(), null, "modelDeclarations", null, 0, -1, EtlProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
