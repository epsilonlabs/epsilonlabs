...
public class EtlPackageImpl extends EPackageImpl implements EtlPackage {
	 ...
	 * @generated
	 */
	public EReference getTransformationRule_DependingRules() {
	...
	public void createPackageContents() {
		...
		createEReference(transformationRuleEClass, TRANSFORMATION_RULE__DEPENDING_RULES);
	...
	public void initializePackageContents() {
		...
		initEReference(getTransformationRule_DependingRules(), this.getTransformationRule(), null, "dependingRules", null, 0, -1, TransformationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
