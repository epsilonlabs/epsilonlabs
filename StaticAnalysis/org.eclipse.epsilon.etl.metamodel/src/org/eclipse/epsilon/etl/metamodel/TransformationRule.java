 ...
 *   <li>{@link org.eclipse.epsilon.etl.metamodel.TransformationRule#getDependingRules <em>Depending Rules</em>}</li>
...
public interface TransformationRule extends EtlElement {
	...
	/**
	 * Returns the value of the '<em><b>Depending Rules</b></em>' reference list.
	 * The list contents are of type {@link org.eclipse.epsilon.etl.metamodel.TransformationRule}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Depending Rules</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Depending Rules</em>' reference list.
	 * @see org.eclipse.epsilon.etl.metamodel.EtlPackage#getTransformationRule_DependingRules()
	 * @model
	 * @generated
	 */
	EList<TransformationRule> getDependingRules();
