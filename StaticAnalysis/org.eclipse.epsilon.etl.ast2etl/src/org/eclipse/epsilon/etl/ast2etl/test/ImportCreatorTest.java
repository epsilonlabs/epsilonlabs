...
public class ImportCreatorTest {
	...
	public void test() {
		...
		EolElement eolElement = context.getEtlElementCreatorFactory().createDomElement(etlModule.getAst(), null, context);

		assertEquals(eolElement.getClass(), EtlProgramImpl.class);
		
		EtlProgram etlProgram = (EtlProgram) eolElement;
		...
		assertEquals(import1.getImportedProgram().getClass(), EolProgramImpl.class);
		assertEquals(import1.getImported().getVal(), "loadModels.eol");
	...
	public void test1() {
		...
		assertEquals(etlProgram.getImports().size(), 1);
		Import import1 = etlProgram.getImports().get(0);
		assertEquals(import1.getImportedProgram().getClass(), EtlProgramImpl.class);
		assertEquals(import1.getImported().getVal(), "imported_etl.etl");
