...
public class PreBlockCreatorTest {
	...
	public void test() {
		...
		PreBlock preBlock = etlProgram.getPreBlocks().get(0);
		...
		assertEquals(target0.getVal(), "beginning transformation...");
		...
		PostBlock postBlock1 = etlProgram.getPostBlocks().get(0);
		...
		assertEquals(target.getVal(), "transformation complete");
