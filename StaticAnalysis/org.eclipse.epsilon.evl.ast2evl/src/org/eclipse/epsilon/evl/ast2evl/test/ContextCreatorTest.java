...
public class ContextCreatorTest {
	...
	public void test() {
		...
		EolElement eolElement = context.getEvlElementCreatorFactory().createDomElement(module.getAst(), null, context);

		assertEquals(eolElement.getClass(), EvlProgramImpl.class);
		EvlProgram evlProgram = (EvlProgram) eolElement;
