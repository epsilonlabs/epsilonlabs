...
public class EvlElementCreatorFactory {
	...
	public EolElement createDomElement(AST ast, EolElement container, Ast2EvlContext context, Class<? extends EolElementCreator> ofCreatorClass)
	{
		EolElement result = null;
		for(EolElementCreator dec: domElementCreators)
		{
	...
	public EvlProgram fetchEvlProgram()
	{
		EvlProgram result = null;
		for(EolElement de: createdEolElements)
		{
			if (de instanceof EvlProgram) {
				result = (EvlProgram) de;
			}
		}
		return result;
