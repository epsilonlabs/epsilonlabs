 ...
 *   <li>{@link org.eclipse.epsilon.eol.metamodel.impl.NameExpressionImpl#isResolvedContentInSameScope <em>Resolved Content In Same Scope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameExpressionImpl extends ExpressionImpl implements NameExpression {
	...
	/**
	 * The default value of the '{@link #isResolvedContentInSameScope() <em>Resolved Content In Same Scope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isResolvedContentInSameScope()
	 * @generated
	 * @ordered
	 */
	protected static final boolean RESOLVED_CONTENT_IN_SAME_SCOPE_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isResolvedContentInSameScope() <em>Resolved Content In Same Scope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isResolvedContentInSameScope()
	 * @generated
	 * @ordered
	 */
	protected boolean resolvedContentInSameScope = RESOLVED_CONTENT_IN_SAME_SCOPE_EDEFAULT;
	 ...
	 * @generated
	 */
	public boolean isResolvedContentInSameScope() {
		return resolvedContentInSameScope;
	}
	 ...
	 * @generated
	 */
	public void setResolvedContentInSameScope(boolean newResolvedContentInSameScope) {
		boolean oldResolvedContentInSameScope = resolvedContentInSameScope;
		resolvedContentInSameScope = newResolvedContentInSameScope;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE, oldResolvedContentInSameScope, resolvedContentInSameScope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE:
				return isResolvedContentInSameScope();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT:
				...
				return;
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE:
				setResolvedContentInSameScope((Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT:
				...
				return;
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE:
				setResolvedContentInSameScope(RESOLVED_CONTENT_IN_SAME_SCOPE_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case EolPackage.NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE:
				return resolvedContentInSameScope != RESOLVED_CONTENT_IN_SAME_SCOPE_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(resolvedContent);
		result.append(", resolvedContentInSameScope: ");
		result.append(resolvedContentInSameScope);
		result.append(')');
