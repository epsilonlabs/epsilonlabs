...
public interface EolPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EOL_LIBRARY_MODULE__MODEL_DECLARATIONS = 0;
	 ...
	 * @ordered
	 */
	int EOL_LIBRARY_MODULE__IMPORTS = 1;
	 ...
	 * @ordered
	 */
	int EOL_LIBRARY_MODULE__OPERATIONS = 2;
	 ...
	 * @ordered
	 */
	int EOL_LIBRARY_MODULE__NAME = 3;
	 ...
	 * @ordered
	 */
	int EOL_LIBRARY_MODULE_FEATURE_COUNT = 4;
