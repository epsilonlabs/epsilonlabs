...
public class EolFactoryImpl extends EFactoryImpl implements EolFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EolPackage.LOGICAL_OPERATOR_EXPRESSION: return createLogicalOperatorExpression();
			case EolPackage.COMPARISON_OPERATOR_EXPRESSION: return createComparisonOperatorExpression();
			case EolPackage.ARITHMETIC_OPERATOR_EXPRESSION: return createArithmeticOperatorExpression();
			default:
	 ...
	 * @generated
	 */
	public LogicalOperatorExpression createLogicalOperatorExpression() {
		LogicalOperatorExpressionImpl logicalOperatorExpression = new LogicalOperatorExpressionImpl();
	 ...
	 * @generated
	 */
	public ArithmeticOperatorExpression createArithmeticOperatorExpression() {
		ArithmeticOperatorExpressionImpl arithmeticOperatorExpression = new ArithmeticOperatorExpressionImpl();
