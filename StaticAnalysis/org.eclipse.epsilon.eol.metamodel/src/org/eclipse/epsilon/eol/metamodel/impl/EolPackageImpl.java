...
public class EolPackageImpl extends EPackageImpl implements EolPackage {
	 ...
	 * @generated
	 */
	public EAttribute getNameExpression_ResolvedContentInSameScope() {
		return (EAttribute)nameExpressionEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(nameExpressionEClass, NAME_EXPRESSION__RESOLVED_CONTENT_IN_SAME_SCOPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNameExpression_ResolvedContentInSameScope(), ecorePackage.getEBoolean(), "resolvedContentInSameScope", null, 0, 1, NameExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
