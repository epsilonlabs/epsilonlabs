...
public class EolPackageImpl extends EPackageImpl implements EolPackage {
	 ...
	 * @generated
	 */
	public EReference getNewExpression_Expression() {
	...
	public void createPackageContents() {
		...
		createEReference(newExpressionEClass, NEW_EXPRESSION__EXPRESSION);
	...
	public void initializePackageContents() {
		...
		keyValueEClass.getESuperTypes().add(this.getExpression());
		...
		modelDeclarationParameterEClass.getESuperTypes().add(this.getExpression());
		...
		collectionInitValueEClass.getESuperTypes().add(this.getExpression());
		...
		initEReference(getNewExpression_Expression(), this.getExpression(), null, "expression", null, 1, 1, NewExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
