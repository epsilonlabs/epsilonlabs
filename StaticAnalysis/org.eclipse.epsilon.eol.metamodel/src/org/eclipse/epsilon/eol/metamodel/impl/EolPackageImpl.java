...
public class EolPackageImpl extends EPackageImpl implements EolPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getImport_ImportedProgram(), this.getEolElement(), null, "importedProgram", null, 1, 1, Import.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
