 ...
 *   <li>{@link org.eclipse.epsilon.eol.metamodel.NameExpression#isResolvedContentInSameScope <em>Resolved Content In Same Scope</em>}</li>
 * </ul>
 * </p>
 *
...
public interface NameExpression extends Expression {
	...
	/**
	 * Returns the value of the '<em><b>Resolved Content In Same Scope</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resolved Content In Same Scope</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resolved Content In Same Scope</em>' attribute.
	 * @see #setResolvedContentInSameScope(boolean)
	 * @see org.eclipse.epsilon.eol.metamodel.EolPackage#getNameExpression_ResolvedContentInSameScope()
	 * @model derived="true"
	 * @generated
	 */
	boolean isResolvedContentInSameScope();

	/**
	 * Sets the value of the '{@link org.eclipse.epsilon.eol.metamodel.NameExpression#isResolvedContentInSameScope <em>Resolved Content In Same Scope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Resolved Content In Same Scope</em>' attribute.
	 * @see #isResolvedContentInSameScope()
	 * @generated
	 */
	void setResolvedContentInSameScope(boolean value);
