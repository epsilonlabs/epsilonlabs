...
public class EweFactoryImpl extends EFactoryImpl implements EweFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case EwePackage.DISPOSE_MODELS_TASK: return createDisposeModelsTask();
      default:
   ...
   * @generated
   */
  public DisposeModelsTask createDisposeModelsTask()
  {
    DisposeModelsTaskImpl disposeModelsTask = new DisposeModelsTaskImpl();
    return disposeModelsTask;
  }
