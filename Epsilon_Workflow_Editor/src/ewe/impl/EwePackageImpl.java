...
public class EwePackageImpl extends EPackageImpl implements EwePackage
{
   ...
   * @generated
   */
  private EClass loadXMLModelTaskEClass = null;
   ...
   * @generated
   */
  public EClass getLoadXMLModelTask()
  {
    return loadXMLModelTaskEClass;
  }
   ...
   * @generated
   */
  public EAttribute getLoadXMLModelTask_File()
  {
    return (EAttribute)loadXMLModelTaskEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getLoadXMLModelTask_Uri()
  {
    return (EAttribute)loadXMLModelTaskEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    loadXMLModelTaskEClass = createEClass(LOAD_XML_MODEL_TASK);
    createEAttribute(loadXMLModelTaskEClass, LOAD_XML_MODEL_TASK__FILE);
    createEAttribute(loadXMLModelTaskEClass, LOAD_XML_MODEL_TASK__URI);
  ...
  public void initializePackageContents()
  {
    ...
    propertyEClass.getESuperTypes().add(this.getTask());
    loadEMFModelTaskEClass.getESuperTypes().add(this.getLoadModelTask());
    loadXMLModelTaskEClass.getESuperTypes().add(this.getLoadModelTask());
    ...
    initEAttribute(getModelNestedElement_Ref(), ecorePackage.getEString(), "ref", null, 0, 1, ModelNestedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getExecutableModelTask_Src(), ecorePackage.getEString(), "src", null, 0, 1, ExecutableModelTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEglTask_Target(), ecorePackage.getEString(), "target", null, 0, 1, EglTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLoadEMFModelTask_ModelFile(), ecorePackage.getEString(), "modelFile", "", 0, 1, LoadEMFModelTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(loadXMLModelTaskEClass, LoadXMLModelTask.class, "LoadXMLModelTask", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLoadXMLModelTask_File(), ecorePackage.getEString(), "file", null, 0, 1, LoadXMLModelTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLoadXMLModelTask_Uri(), ecorePackage.getEString(), "uri", null, 0, 1, LoadXMLModelTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createGmf_1Annotations()
  {
    ...
    addAnnotation
      (loadXMLModelTaskEClass, 
       source, 
       new String[] 
       {
       "tool.name", "Load XML Model Task"
       });		
    addAnnotation
      (flockTaskEClass, 
       source, 
