...
public interface EweFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Dispose Models Task</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Dispose Models Task</em>'.
   * @generated
   */
  DisposeModelsTask createDisposeModelsTask();
