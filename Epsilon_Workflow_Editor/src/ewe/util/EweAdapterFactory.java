...
public class EweAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EweSwitch<Adapter> modelSwitch =
    new EweSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseLoadXMLModelTask(LoadXMLModelTask object)
      {
        return createLoadXMLModelTaskAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link ewe.Property <em>Property</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link ewe.LoadXMLModelTask <em>Load XML Model Task</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
