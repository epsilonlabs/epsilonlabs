...
public class EweSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case EwePackage.PROPERTY:
      {
        Property property = (Property)theEObject;
        T result = caseProperty(property);
        if (result == null) result = caseTask(property);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case EwePackage.LOAD_XML_MODEL_TASK:
      {
        LoadXMLModelTask loadXMLModelTask = (LoadXMLModelTask)theEObject;
        T result = caseLoadXMLModelTask(loadXMLModelTask);
        if (result == null) result = caseLoadModelTask(loadXMLModelTask);
        if (result == null) result = caseEpsilonTask(loadXMLModelTask);
        if (result == null) result = caseTask(loadXMLModelTask);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Load XML Model Task</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Load XML Model Task</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLoadXMLModelTask(LoadXMLModelTask object)
  {
    return null;
  }
