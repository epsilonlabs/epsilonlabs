...
public interface Task extends EObject
{
   ...
   *        annotation="gmf.link label='follows' target.decoration='arrow' style='dash' color='0,0,0' width='3' tool.small.bundle='Epsilon_Workflow_Editor.edit' tool.small.path='icons/full/obj16/Follows.gif'"
   * @generated
   */
  Task getFollows();
