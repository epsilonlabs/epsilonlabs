...
public interface Target extends EObject
{
   ...
   * @model annotation="gmf.link label='depends' target.decoration='filledclosedarrow' style='dash' width='3' tool.small.bundle='Epsilon_Workflow_Editor.edit' tool.small.path='icons/full/obj16/Depends.gif'"
   * @generated
   */
