...
public interface EwePackage extends EPackage
{
   ...
   * @ordered
   */
  int DISPOSE_MODEL_TASK_FEATURE_COUNT = EPSILON_TASK_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link ewe.impl.PropertyImpl <em>Property</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see ewe.impl.PropertyImpl
   * @see ewe.impl.EwePackageImpl#getProperty()
   * @generated
   */
  int PROPERTY = 20;
   ...
   * @ordered
   */
  int PROPERTY__FOLLOWS = TASK__FOLLOWS;
   ...
   * @ordered
   */
  int PROPERTY__FOLLOWER = TASK__FOLLOWER;
   ...
   * @ordered
   */
  int PROPERTY__ATTRIBUTES = TASK__ATTRIBUTES;
   ...
   * @ordered
   */
  int PROPERTY__TASKELEMENTS = TASK__TASKELEMENTS;
   ...
   * @ordered
   */
  int PROPERTY_FEATURE_COUNT = TASK_FEATURE_COUNT + 0;
  ...
  /**
   * The meta object id for the '{@link ewe.impl.LoadXMLModelTaskImpl <em>Load XML Model Task</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see ewe.impl.LoadXMLModelTaskImpl
   * @see ewe.impl.EwePackageImpl#getLoadXMLModelTask()
   * @generated
   */
  int LOAD_XML_MODEL_TASK = 24;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__NAME = LOAD_MODEL_TASK__NAME;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__FOLLOWS = LOAD_MODEL_TASK__FOLLOWS;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__FOLLOWER = LOAD_MODEL_TASK__FOLLOWER;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__ATTRIBUTES = LOAD_MODEL_TASK__ATTRIBUTES;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__TASKELEMENTS = LOAD_MODEL_TASK__TASKELEMENTS;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__PARAMETERS = LOAD_MODEL_TASK__PARAMETERS;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__TYPE = LOAD_MODEL_TASK__TYPE;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__FILE = LOAD_MODEL_TASK_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LOAD_XML_MODEL_TASK__URI = LOAD_MODEL_TASK_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Load XML Model Task</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int LOAD_XML_MODEL_TASK_FEATURE_COUNT = LOAD_MODEL_TASK_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for class '{@link ewe.Property <em>Property</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link ewe.LoadXMLModelTask <em>Load XML Model Task</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Load XML Model Task</em>'.
   * @see ewe.LoadXMLModelTask
   * @generated
   */
  EClass getLoadXMLModelTask();

  /**
   * Returns the meta object for the attribute '{@link ewe.LoadXMLModelTask#getFile <em>File</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>File</em>'.
   * @see ewe.LoadXMLModelTask#getFile()
   * @see #getLoadXMLModelTask()
   * @generated
   */
  EAttribute getLoadXMLModelTask_File();

  /**
   * Returns the meta object for the attribute '{@link ewe.LoadXMLModelTask#getUri <em>Uri</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Uri</em>'.
   * @see ewe.LoadXMLModelTask#getUri()
   * @see #getLoadXMLModelTask()
   * @generated
   */
  EAttribute getLoadXMLModelTask_Uri();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link ewe.impl.PropertyImpl <em>Property</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see ewe.impl.PropertyImpl
     * @see ewe.impl.EwePackageImpl#getProperty()
    ...
    /**
     * The meta object literal for the '{@link ewe.impl.LoadXMLModelTaskImpl <em>Load XML Model Task</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see ewe.impl.LoadXMLModelTaskImpl
     * @see ewe.impl.EwePackageImpl#getLoadXMLModelTask()
     * @generated
     */
    EClass LOAD_XML_MODEL_TASK = eINSTANCE.getLoadXMLModelTask();
     ...
     * @generated
     */
    EAttribute LOAD_XML_MODEL_TASK__FILE = eINSTANCE.getLoadXMLModelTask_File();
     ...
     * @generated
     */
    EAttribute LOAD_XML_MODEL_TASK__URI = eINSTANCE.getLoadXMLModelTask_Uri();
