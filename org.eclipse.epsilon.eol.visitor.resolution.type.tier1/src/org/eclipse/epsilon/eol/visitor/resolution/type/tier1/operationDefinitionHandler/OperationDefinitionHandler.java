...
public abstract class OperationDefinitionHandler {
	...
	public abstract OperationDefinition handle(FeatureCallExpression featureCallExpression, Type contextType, ArrayList<Type> argTypes, TypeResolutionContext context);
}
