...
public class StringUtilityHandler extends StringOperationDefinitionHandler {
	...
	public boolean appliesTo(String name, Type contextType,
		...
		if ((name.equals("isInteger") ||
				name.equals("isReal") || 
				name.equals("length") ||
				name.equals("firstToLowerCase") ||
				name.equals("firstToUpperCase") ||
				name.equals("toLowerCase") ||
