...
/**
 * Simple rule that just concatenates the terminals.
 * 
 * @author zschaler
 */
public class ConcatenationRule extends AbstractCompositionRule implements
	...
	public void compose(FSTTerminal terminalA, FSTTerminal terminalB,
		...
		StringConcatenation.compose(terminalA, terminalB, terminalComp,
				nonterminalParent);
	}
