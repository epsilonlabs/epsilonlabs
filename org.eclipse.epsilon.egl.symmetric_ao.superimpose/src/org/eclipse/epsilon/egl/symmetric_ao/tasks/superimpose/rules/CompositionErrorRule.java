...
/**
 * Adapter for FeatureHouse's CompositionError composition rule.
 * 
 * @author zschaler
 * 
 */
public class CompositionErrorRule extends AbstractCompositionRule implements
	...
	public void compose(FSTTerminal terminalA, FSTTerminal terminalB,
		...
		CompositionError.compose(terminalA, terminalB, terminalComp,
				nonterminalParent);
	}
}