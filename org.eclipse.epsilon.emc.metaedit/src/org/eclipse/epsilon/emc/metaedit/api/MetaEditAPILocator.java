...
public class MetaEditAPILocator extends org.apache.axis.client.Service implements MetaEditAPI {
    ...
    public MetaEditAPIPortType getMetaEditAPIPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MetaEditAPISoapBindingStub _stub = new MetaEditAPISoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MetaEditAPIPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                MetaEditAPISoapBindingStub _stub = new MetaEditAPISoapBindingStub(new java.net.URL(MetaEditAPIPort_address), this);
                _stub.setPortName(getMetaEditAPIPortWSDDServiceName());
                return _stub;
            }
        }
