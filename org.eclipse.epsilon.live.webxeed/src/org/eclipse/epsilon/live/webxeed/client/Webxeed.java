...
public class Webxeed implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		dockLayoutPanel.addSouth(textbox, 200);
		
		final Tree tree = new Tree();
		
		emfModelRetrievalService.getEmfModel(null, null, new AsyncCallback<WObject>() {
			...
			public void onSuccess(WObject result) {
				TreeItem t1 = tree.addTextItem(result.getTitle());
				for (WObject child : result.getContents()) {
					t1.addTextItem(child.getTitle());
				}
		...
		tree.addSelectionHandler(new SelectionHandler<TreeItem>() {
			...
			public void onSelection(SelectionEvent<TreeItem> event) {
				...
				/*
				greetingService.greetServer(event.getSelectedItem().getText(), new AsyncCallback<String>() {
