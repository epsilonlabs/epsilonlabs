...
/**
 * This is the item provider adapter for a {@link ewe.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EwePackage.Literals.PROJECT__NAME,
         true,
         false,
         false,
  ...
  protected void addDefaultTargetPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Project_defaultTarget_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Project_defaultTarget_feature", "_UI_Project_type"),
         EwePackage.Literals.PROJECT__DEFAULT_TARGET,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(EwePackage.Literals.PROJECT__TARGETS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (EwePackage.Literals.PROJECT__TARGETS,
         EweFactory.eINSTANCE.createTarget()));
  }
