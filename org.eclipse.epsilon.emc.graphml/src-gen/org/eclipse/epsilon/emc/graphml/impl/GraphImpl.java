 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.emc.graphml.impl.GraphImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link org.eclipse.epsilon.emc.graphml.impl.GraphImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GraphImpl extends EObjectImpl implements Graph {
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, GraphmlPackage.GRAPH__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphmlPackage.GRAPH__TYPES:
