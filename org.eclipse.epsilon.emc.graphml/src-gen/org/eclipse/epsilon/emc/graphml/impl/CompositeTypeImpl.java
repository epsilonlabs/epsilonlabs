 ...
 * <ul>
 *   <li>{@link org.eclipse.epsilon.emc.graphml.impl.CompositeTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeTypeImpl extends TypeImpl implements CompositeType {
	...
	protected EClass eStaticClass() {
		return GraphmlPackage.Literals.COMPOSITE_TYPE;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, GraphmlPackage.COMPOSITE_TYPE__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphmlPackage.COMPOSITE_TYPE__TYPES:
