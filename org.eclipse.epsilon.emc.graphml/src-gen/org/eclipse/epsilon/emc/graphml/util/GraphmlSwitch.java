 ...
 * @generated
 */
public class GraphmlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GraphmlPackage.SLOT: {
				Slot slot = (Slot)theEObject;
				T result = caseSlot(slot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphmlPackage.TYPE: {
			...
			case GraphmlPackage.INTEGER_TYPE: {
			...
			case GraphmlPackage.STRING_TYPE: {
			...
			case GraphmlPackage.BOOLEAN_TYPE: {
